...
Vidux is a **single entry point** — `/vidux` — that covers both planning and automation. Previously separate companion commands were merged into `/vidux` or pruned as orphaned.
