...
- [ ] **11.3 Tighten vidux-loop.sh to explicit reduce mode** — Add hard 2-minute budget. Add `next_action: dispatch|none` to JSON output. Forbid code changes in reduce mode (read-only assessment). [Evidence: Gastown Witness pattern, burst-vs-watch-mode-insight.md] [Depends: 11.1]
