...
- `scripts/` — vidux-loop.sh, vidux-checkpoint.sh, vidux-doctor.sh, vidux-fleet-quality.sh, vidux-fleet-rebuild.sh, vidux-test-all.sh
...
- `guides/` — draft-pr-flow.md, evidence-format.md, fleet-ops.md, harness.md, investigation.md
...
- **Radar template** — shared harness template for read-only observer automations (`guides/harness.md`). ~800-1200 chars per radar prompt.
